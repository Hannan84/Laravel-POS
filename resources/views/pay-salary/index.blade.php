                ...
                <table class="table mb-0">
                    ...
                    <tbody class="ligth-body">
                        ...
                        <tr>
                            ...
                            <td>Tk {{ $advanceSalary->employee->salary }}</td>
                            <td>{{ $advanceSalary->advance_salary ? 'Tk '.$advanceSalary->advance_salary : 'No Advance' }}</td>
                            <td>Tk {{ $advanceSalary->employee->salary - $advanceSalary->advance_salary }}</td>
                            <td>
